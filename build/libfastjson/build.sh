...
VER=0.99.8
VERHUMAN=$VER
PKG=oep/library/fastjson
SUMMARY="A FASTJSON implementation in C"
DESC="A FASTJSON implementation in C"
...
DOWNLOADURL=http://download.rsyslog.com/libfastjson/libfastjson-0.99.8.tar.gz
