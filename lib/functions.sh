...
PATH="/opt/gcc-9/bin:/opt/oep/bin:/usr/ccs/bin:/usr/bin:/usr/sbin:/usr/gnu/bin:/usr/sfw/bin"
export PATH
...
BasicRequirements(){
    local needed=""
    [[ -x /opt/gcc-9/bin/gcc ]] || needed+=" developer/gcc9"
...
make_package() {
    ...
    echo "set name=publisher value=\"contact@oetiker.ch\"" >> $MY_MOG_FILE
